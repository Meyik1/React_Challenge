...
const CategoriaButton = styled(Button)(({ theme }) => ({
    [theme.breakpoints.down('md')]: {
      display: 'none', // esconde el boton en ventanas pequeñas (breakpoint: 960px)
    },
}));
...
function FormularioVideos() {
    ...
    const resetForm = () => {
        reset(); // Resetea el formulario a su valor inicial 
    };
            ...
            <Container maxWidth="xl" >
              <form onSubmit={handleSubmit(onSubmit)}>
                <Grid rowSpacing={5} container sx={{}}>
                  ...
                  <Grid  xs={12}>
                    <DropzoneContainer {...getRootProps({ className: 'dropzone' })}>
                      {previewImage ? (
                        ...
                        <p>Arrastra tu imagen aquí , o haga click para seleccionar una foto</p>
                      )}
                    </DropzoneContainer>
                  ...
                  <Grid xs={12} direction="row" sx={{ display: 'flex', justifyContent: 'space-between' }} >
                    <ButtonGroup variant="contained" size="large" aria-label="small button group"
                      sx={{
                        '& > *': {
                          marginRight: '16px', // Ajusta el margen entre botones
                        },
                        '& > *:nth-of-type(2)': {
                          marginLeft: '32px', // Ajusta el margen entre botones
                        },
                        '@media (max-width:960px)': {
                          ...
                          '& > *': {
                            marginRight: '0px', // Ajusta el margen entre botones
                          },
                          '& > *:nth-of-type(2)': {
                            marginLeft: '0px', // Ajusta el margen entre botones
                          },
                        }
                      }}>    
